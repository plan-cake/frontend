...
import DashboardCopyButton from "@/app/ui/components/dashboard/dashboard-copy-button";
import DateRangeRow from "@/app/ui/components/dashboard/date-range-row";
import WeekdayRow from "@/app/ui/components/dashboard/weekday-row";
  ...
  return (
    <Link href={`/${code}`}>
      <div className="flex w-full flex-col rounded-lg bg-white p-4 transition-shadow hover:shadow-lg hover:shadow-black/25 dark:bg-violet">
        <div className="rounded bg-white text-lg leading-tight font-bold dark:bg-violet">
          {title}
        </div>
